...
관심사 기반 SNS Vingle에서 커리어를 시작했고, 이후 회사의 사업 전환을 거치며 커뮤니티·커머스 기반 SaaS 노코드 솔루션을 개발했습니다.
현재는 캐치테이블에서 매장을 위한 B2B 프론트엔드를 개발하고 있습니다.

중학교 시절 프로그래밍을 처음 접하며 개발자의 꿈을 키웠고, 소프트웨어 마이스터고를 졸업한 뒤 19살부터 커리어를 시작했습니다. 스타트업에서 오랜 시간 제품을 만들며 빠른 실행과 완성도, 편의성과 안정성 사이의 트레이드오프를 끊임없이 고민해왔습니다.
...
- 빗썸, 토스페이, 캐치페스타, 흑백요리사 등 다양한 프로모션 페이지 개발
  ...
  - 빗썸 제휴 프로모션 개발로 월 2억 원 규모 매출 창출에 기여, 연 단위 계약 논의로 확장되는 성과 달성
  - ‘흑백요리사’ 프로모션 프로젝트 참여, 약 3만 건 예약 유입 달성
