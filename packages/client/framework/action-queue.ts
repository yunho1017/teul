...
import { RouterAction, RouterState, ReducerState } from "./router/types";

export type DispatchStatePromise = React.Dispatch<ReducerState>;

export type AppRouterActionQueue = {
  state: RouterState;
  dispatch: (payload: RouterAction, setState: DispatchStatePromise) => void;
  action: (state: RouterState, action: RouterAction) => ReducerState;
};
